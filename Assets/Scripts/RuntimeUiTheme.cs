...
{
    public static readonly Color BackgroundColor = new Color32(0x9F, 0xF2, 0xEE, 0xFF);
    public static readonly Color TextColor = new Color32(0xFF, 0xC5, 0xE1, 0xFF);
    ...
    public static readonly Color ButtonLabelColor = TextColor;
}
